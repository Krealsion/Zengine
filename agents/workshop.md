...
| a pane's code: the host's join from an office to its artifact and recipes, Edit Code, the Builder following it, an editing entry, Workshop's own panes as a development catalog and runtime | [code](workshop/code.md) `WL-CODE` |

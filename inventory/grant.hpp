...
inline loom::Grant inventory_grant() {
    ...
    g.allow_to_any(v2::InventoryListed::zen_name, v2::InventoryListed::zen_version);
    g.allow_to_any(InventoryFolderState::zen_name, InventoryFolderState::zen_version);
    ...
    g.allow_to_any(v2::InventorySnapshot::zen_name, v2::InventorySnapshot::zen_version);
